  ...
  <v-app style="background: #E3E3EE">
    ...
    <main>
      <v-container class="mt-4">
        ...
        >
          <v-icon class="mr-3">cancel</v-icon>
          <h3>A confirmation email has been sent,please check your email box!</h3>
          <v-btn
            dark
            flat
            @click="emailSentState = false"
          >Close</v-btn>
        </v-snackbar> -->
...
export default {
  ...
  computed: {
    ...
    horizontalNavItems() {
      // this.emailConfirmed = this.confirmed;
      ...
      if (this.user && this.user.confirmed == true) {
        // this.emailConfirmed = true;
